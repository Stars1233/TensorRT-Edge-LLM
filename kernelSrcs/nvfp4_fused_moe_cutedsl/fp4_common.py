...
@dsl_user_op
def scatter_add_f16x2(addr: Int64, val0_f32, val1_f32, *, loc=None, ip=None):
    """F16x2 atomic reduction add to global memory.

    Packs two f32 values into f16x2 via cvt.rn.satfinite, then does
    red.relaxed.gpu.global.add.noftz.f16x2.
    """
    llvm.inline_asm(
        None,
        [
        ...
        "{ .reg .b32 packed;"
        " cvt.rn.satfinite.f16x2.f32 packed, $2, $1;"
        " red.relaxed.gpu.global.add.noftz.f16x2 [$0], packed; }",
        "l,f,f",
        has_side_effects=True,
        is_align_stack=False,
        asm_dialect=llvm.AsmDialect.AD_ATT,
