...
class Qwen3TTSTalkerAttention(QKNormDecoderAttention):
    """Qwen3-TTS talker attention extension point."""


class Qwen3TTSTalkerDecoderLayer(DecoderLayer):
    """Qwen3-TTS talker layer composed from shared primitive modules."""

    attention_class = Qwen3TTSTalkerAttention


class Qwen3TTSTalkerModel(DecoderModel):
    """Qwen3-TTS talker stack and model-family extension point."""

    layer_class = Qwen3TTSTalkerDecoderLayer


class Qwen3TTSTalker(NetworkModule):
    """Qwen3-TTS autoregressive talker and its engine I/O contract."""

    def __init__(self, ctx) -> None:
        super().__init__(ctx)
        self.model = Qwen3TTSTalkerModel(ctx)
