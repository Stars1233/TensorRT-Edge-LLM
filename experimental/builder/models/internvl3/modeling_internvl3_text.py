...
"""InternVL3 dense text model family."""
...
__all__ = [
    "BuildContext",
    "Linear",
    "InternVL3TextAttention",
    "InternVL3TextDecoderLayer",
    "InternVL3TextModel",
    "InternVL3CausalLM",
    "Module",
    "NetworkModule",
...
class InternVL3TextAttention(DecoderAttention):
    """InternVL3 nested Qwen2 attention extension point."""


class InternVL3TextDecoderLayer(DecoderLayer):
    """InternVL3 text layer composed from shared primitive modules."""

    attention_class = InternVL3TextAttention


class InternVL3TextModel(DecoderModel):
    """InternVL3's nested Qwen2 decoder stack."""

    layer_class = InternVL3TextDecoderLayer


class InternVL3CausalLM(NetworkModule):
    """Dense checkpoint-backed causal language-model graph."""

    def __init__(self, ctx: BuildContext) -> None:
        super().__init__(ctx)
        self.model = InternVL3TextModel(ctx)
