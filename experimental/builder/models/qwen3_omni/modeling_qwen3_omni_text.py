...
"""Qwen3-Omni dense thinker model."""
...
class Qwen3OmniThinkerAttention(QKNormDecoderAttention):
    """Dense Qwen3-Omni thinker attention."""


class Qwen3OmniThinkerDecoderLayer(DecoderLayer):
    """Dense Qwen3-Omni thinker decoder layer."""

    attention_class = Qwen3OmniThinkerAttention


class Qwen3OmniThinkerModel(DecoderModel):
    """Dense Qwen3-Omni thinker stack."""

    layer_class = Qwen3OmniThinkerDecoderLayer


class Qwen3OmniThinker(NetworkModule):
    """Qwen3-Omni dense thinker network and runtime I/O contract."""

    def __init__(self, ctx) -> None:
        super().__init__(ctx)
        self.model = Qwen3OmniThinkerModel(ctx)
    ...
    def forward(self, **io):
        ...
        if self.cfg.engine_role == "base":
            ...
            feedback = (all_hidden_states[accepted_index - 1]
