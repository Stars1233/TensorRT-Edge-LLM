...
class Qwen3VLMerger(VisionPatchMerger):
    """Qwen3-VL patch-merger extension point."""


class Qwen3VLVisionBlock(VisionTransformerBlock):
    """Qwen3-VL visual-block extension point."""


class Qwen3VLVisualEncoder(NetworkModule):
    ...
    def __init__(self, ctx, bundle) -> None:
        ...
        self.blocks = [
            Qwen3VLVisionBlock(ctx, prefix, self.hidden_size, self.num_heads,
                               self.hidden_act)
        ...
        self.final_merger = Qwen3VLMerger(
    ...
    def forward(self, **io):
        ...
        hidden = self.fast_position(hidden, io["fast_pos_embed_idx"],
