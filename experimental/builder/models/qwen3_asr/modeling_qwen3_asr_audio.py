...
"""Qwen3-ASR audio component and engine I/O contract."""
...
class Qwen3ASRAudioTransformer(AudioTransformer):
    """Qwen3-ASR audio stack with its provider-defined GELU policy."""

    def __init__(self, ctx, config) -> None:
        super().__init__(ctx, config, activation="gelu")


class Qwen3ASRAudioEncoder(NetworkModule):
    """End-to-end Qwen3-ASR audio encoder graph."""
    ...
    def __init__(self, ctx, bundle) -> None:
        ...
        self.transformer = Qwen3ASRAudioTransformer(ctx, self.config)
    ...
    def forward(self, features, indices, attention_mask):
        ...
        hidden_states = self.proj1(self.ln_post(hidden_states)).gelu()
