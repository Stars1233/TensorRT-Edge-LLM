...
class Qwen3_5MoeVisionPatchMerger(VisionPatchMerger):
    """Qwen3.5-MoE patch-merger extension point."""


class Qwen3_5MoeVisionBlock(VisionTransformerBlock):
    """Qwen3.5-MoE visual-block extension point."""


class Qwen3_5MoeVisionModel(NetworkModule):
    """Qwen3.5-MoE vision transformer."""
    ...
    def __init__(self, ctx, bundle) -> None:
        ...
        self.blocks = [
            Qwen3_5MoeVisionBlock(ctx, prefix, self.hidden_size,
