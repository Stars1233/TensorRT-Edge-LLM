...
"""Qwen2.5-VL dense text model family."""
...
class Qwen2_5_VLAttention(DecoderAttention):
    """Qwen2.5-VL text attention extension point."""


class Qwen2_5_VLDecoderLayer(DecoderLayer):
    """Qwen2.5-VL text layer composed from shared primitive modules."""

    attention_class = Qwen2_5_VLAttention


class Qwen2_5_VLTextModel(DecoderModel):
    """Configuration-driven dense decoder stack."""

    layer_class = Qwen2_5_VLDecoderLayer


class Qwen25VLCausalLM(NetworkModule):
    """Dense checkpoint-backed causal language-model graph."""

    def __init__(self, ctx: BuildContext) -> None:
        super().__init__(ctx)
        self.model = Qwen2_5_VLTextModel(ctx)
