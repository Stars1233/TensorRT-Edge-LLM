...
friendly forward / mask methods, mirroring the legacy
``tensorrt_edgellm.llm_models.models.nemotron_h_patch`` (kept here as a
self-contained copy so ``experimental.quantization`` stays decoupled
from ``tensorrt_edgellm``).
